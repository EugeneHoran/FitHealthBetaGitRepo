...
public class FragmentFitbit extends Fragment {
    ...
    public class FitbitGetActivityStats extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                try {
                    ...
                    distance = getActivityDailyGoalsResults.get_Distance();
                } catch (Exception e) {
                ...
                try {
                    ...
                    distanceGO = distance.get("value").toString();
                } catch (Exception e) {
        ...
        protected void onPostExecute(String result) {
             ...
             * Activity
             */
            sedentary.setText(sedentaryMinutes + " minutes");
            light.setText(lightlyActiveMinutes + " minutes");
            fairly.setText(fairlyActiveMinutes + " minutes");
            very.setText(veryActiveMinutes + " minutes");
