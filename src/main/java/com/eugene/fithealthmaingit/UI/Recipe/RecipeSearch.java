...
public class RecipeSearch extends Fragment implements AbsListView.OnScrollListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mListViewSearchResults.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                mCallbacks.searchFragment(mItem.get(position).getID(), mItem.get(position).getBrand());
            }
        });
        ...
        mToolbarSearch.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((InputMethodManager) getActivity().getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(mToolbarSearch.getWindowToken(), 0);
                getActivity().finish();
            }
        });
    ...
    public interface FragmentCallbacks {
        void searchFragment(String s, String brand);
    }
